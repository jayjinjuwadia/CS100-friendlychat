...
public class groupchat_jay extends MainActivity {
    private Button butt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*  StorageTask f = mGod.getReference().getFile(mGod.getReference().child("god.txt").getDownloadUrl().getResult()).addOnFailureListener(new OnFailureListener() {
        ...
        mGroupAdapter = new Groupchatadapter(groupchat_jay.this, R.layout.activity_groupchat_jay ,gcarray);
        ...
        mData2.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, String parent) {
                ...
                if (dataSnapshot.getKey().startsWith("groupchat_jay")) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(groupchat_jay.this,"MMMMMMMMMM TOASTY", Toast.LENGTH_LONG).show();
            }
        });
